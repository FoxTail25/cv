...
export const Technick = () => {

    const [imgSrc, setImgSrc] = useState()
    const [sertText, setSertText] = useState('')
        ...
        <>
            <div className='education__list flex_column'>
                ...
                <h5 className='education__accordion__header_text'>
                    Техникум Автоматизации и радиоэлектроники
                </h5>

                <div className='flex_row education__block' onClick={() => handleOpen()}>
                    <h4 className='education_text' onClick={(e) => getImgSrc(e)}>Диплом о среднем образовании</h4>
                    <img src='./img/diplom/technick.jpg' alt='Сертификат HTML и CSS' className='education__sertificate' onClick={(e) => getImgSrc(e)} />
                </div>
